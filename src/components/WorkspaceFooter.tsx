  ...
  return (
    <footer className="border-t border-line bg-[#f3f4f5] px-5 py-10 sm:px-8 lg:px-10">
      <div className="mx-auto grid max-w-7xl gap-8 text-sm sm:grid-cols-2 lg:grid-cols-4">
        <div>
          <p className="font-display font-semibold">PdfDocs</p>
        ...
        <p className="text-xs leading-5 text-muted lg:text-right">© {new Date().getFullYear()} PdfDocs.<br />Private browser-based PDF processing.</p>
      </div>
    </footer>
  )
}
